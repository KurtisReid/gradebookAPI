...
public class GradeRepoTests {
    ...
    public void create_grade()
    {
        ...
        Grade grade = new Grade(1,student,1010, "bad student", Behavior.EVIL);
    ...
    public void get_grades_by_sId(){
        ...
        Grade grade1 = new Grade(0,student1,1010, "bad student", Behavior.EVIL);
        Grade grade2 = new Grade(0,student1,1010, "bad student", Behavior.GOOD);
        Grade grade3 = new Grade(0,student2,1010, "bad student", Behavior.EVIL);
        ...
        List<Grade> grades = this.gradeRepo.findGradesByStudentId(savedStudent1);
